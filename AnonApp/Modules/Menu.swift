...
class SettingsMenuQuip:Menu{
    ...
    override func populateMenuItems(){
        ...
        menuItems = [MenuItem(name: "Link Email", imageName: "link"), MenuItem(name: "Privacy Policy", imageName: "doc.text"),MenuItem(name: "EULA", imageName: "doc.text"), MenuItem(name:"Report a Problem", imageName:"flag"), MenuItem(name:"Contact Us", imageName:"envelope"), MenuItem(name:"Share", imageName: "arrowshape.turn.up.right.fill"),  MenuItem(name:"Cancel", imageName: "multiply")]
